...
{% include anchor.html id="délai-retractation" label="Ai-je un droit / délai de rétractation ?" %}
...
###Mes identifiants de compte client du site du libraire sont-ils valables sur le store de la liseuse ?
...
###Mes commandes passées depuis votre site internet sont-elles visibles dans mon compte depuis la boutique de la liseuse ?
...
{% include anchor.html id="langue-menu-cybook" label="Comment régler la langue du menu ?" %}
###Comment régler la langue du menu ?
...
Ce choix n'est pas définitif, vous pouvez changer la langue du Menu plus tard si vous le désirez :
...
{% include anchor.html id="supprimer-livres-cybook" label="Comment supprimer des livres de ma liseuse Cybook ?" %}
###Comment supprimer des livres de ma liseuse Cybook ?

- Allez dans « Bibliothèque ».
- Cliquez le livre à supprimer qui s'ouvre.
- Appuyez sur le bouton central.
- Cliquez sur « Bibliothèque » (apparition du livre à supprimer dans la bibliothèque).
- Cliquez sur le bouton central.
- Cliquez sur « Menu ».
- déroulez le menu vers le bas.
- appuyez sur « Effacer ».
- OK.
...
{% include anchor.html id="couleur-diode" label="Quelle doit-être la couleur de la diode ?" %}
...
Dans « Bibliothèque » > « Images » sélectionnez l’image que vous souhaitez définir comme économiseur d’écran. Quand le menu contextuel apparaît il vous faut alors confirmer que vous voulez bien afficher cette image comme économiseur.

{% include anchor.html id="maj-cybook" label="Où trouver sur ma liseuse Cybook la mise à jour en vigueur ?" %}
...
{% include anchor.html id="boo-reader" label="Qu'est-ce que « Boo Reader » ?" %}
...
{% include anchor.html id="programmes-supplementaires" label="Est-ce que des logiciels ou des programmes supplémentaires peuvent être installés sur ma liseuse Cybook ?" %}
...
{% include anchor.html id="cybook-bloque" label="Ma liseuse Cybook est bloquée sur une page, que dois-je faire ?" %}
...
Appuyez sur le bouton marche/arrêt et tenez-le pendant 10 secondes. Quand la liseuse Cybook est éteinte vous pouvez la rallumer en appuyant à nouveau sur le bouton. Il faudra cette fois-ci le maintenir appuyé pendant seulement 2 secondes.
